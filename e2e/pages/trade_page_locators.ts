export const locators = {
    ...
    clickToppoolsToken:
        'xpath=//*[@id=\'root\']/div[1]/section/section/div[1]/div[2]/div[1]/div[1]/div/div[3]/div/div[2]/div[1]/a/div[1]',
    clickRecentpoolsToken:
        'xpath=//*[@id=\'root\']/div[1]/section/section/div[1]/div[2]/div[1]/div[1]/div/div[3]/div/div[2]',
    clickOpenAllDropdown: '[id=\'sidebar_collapse_all_button\']',
    clickReverseArrow: 'Reverse tokens',
    clickAddFav: '[id=\'trade_fav_button\']',
    ...
    clickRecentPairs:
        'xpath=//*[@id=\'root\']/div[1]/section/section/div[1]/div[2]/div[1]/div[1]/div/div[2]/button[3]',
    ...
    getMaxPercentage: '[id=\'max_price_of_range_advanced\']',
    getLeaderboard:
        'xpath=//*[@id="position-0xae7deb91c520c3c69226b046597eaec4eaffc910c8ad6ed1412bc967dac43755"]/div[3]',
    ...
    fullScreenBtn: '[id=\'trade_chart_full_screen_button\']',
    swapModuleBtn: '[id=\'limits_tab_clickable\']',
    usdPriceBtn: '[id=\'trade_dollarized_prices_button\']',
    usdPrice:
        '#root > div.Container__FlexContainer-sc-1b686b3-0.gVTOxi.content-container-trade > section > section > div.Container__FlexContainer-sc-1b686b3-0.dArrqj > section > section > div > div.Container__FlexContainer-sc-1b686b3-0.eEDAnH > div > div.Container__FlexContainer-sc-1b686b3-0.knLYBe',
    transactionRow: '#tx_row_0',
    transactionPopup: '#Modal_Global > div',
    chatBox: '[id=\'box\']',
    chatRoomDropdown: '#room-dropdown',
    chatSelectPool: '[id=\'ETH / WBTC\']',
    chatOpenTrollbox: '[id=\'chat-open-close-trollbox\']',
    chatOpenRoomDropdown: '[id=\'chat-open-close-room-dropdown-button\']',
    chatOpenRoomDropdownName: '[id=\'chat-open-close-room-dropdown\']',
    chatLastButton: '[id=\'chat-scroll-bottom\']',
    ...
    chatMessageBodyXpath: '//*[contains(@class, "chatmessage")]',
    chatLastMessage: '[id=\'thelastmessage\']',
    chatPreviousButton: '[id=\'chat-previous-messages\']',
    chatInfoPanel:
        'xpath=//*[@id="root"]/div[2]/div/div[2]/div/div[7]/div[2]/ul/h5',
    chatPoolName:
        'xpath=//*[@id="root"]/div[2]/div/div[2]/div/div[3]/div/div[1]',
    chatPoolFav: '[id=\'USDC / USDT\']',
    chatPoolAdmin: '[id=\'Admins\']',
    currentPoolButton: '[id=\'currentpool-button\']',
};
